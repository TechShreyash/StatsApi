// C:/Users/hp/AppData/Roaming/npm/node_modules/wrangler/node_modules/@esbuild-plugins/node-globals-polyfill/process.js
...
// C:/Users/hp/AppData/Roaming/npm/node_modules/wrangler/node_modules/@esbuild-plugins/node-globals-polyfill/Buffer.js
var lookup = [];
var revLookup = [];
...
// dbHandler.js
var apiKey = "dzhlNuyl6Cbypq1T15wPF8lyG3tsQKZkTF9MoVZSlxRX6zw37qi56lm9yKuM14z8";
var database = "AnimeThumb";
var collection1 = "ThumbUrls";
var collection2 = "WebsiteViews";
...
async function IncreasePageViews(website) {
  await updateRecord(website, {
    "$inc": { "views": 10 }
  }, collection2);
}
    ...
    if (request.method === "OPTIONS") {
      ...
      if (url.includes("/inc")) {
        ...
        if (referer == "null") {
          ...
          const url2 = new URL(referer);
          referer = url2.hostname;
        }
